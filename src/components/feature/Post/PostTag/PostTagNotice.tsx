...
import styles from '@/components/feature/Post/PostTag/PostTagNotice.module.scss';
...
export default function PostTagNotice({ closed, hourlyPay, originalHourlyPay }: PostTagprops) {
